...
public class First {
    ...
    public First(String weight, String vfat, String tsf, String totalfatpercent, String metabolicage, String bmi, String bmr, String musclepercent, String weektype, String created_date) {
        this.weight = weight;
        this.vfat = vfat;
        this.tsf = tsf;
