...
import com.example.healthclub_app.Activities.FullScreen;
import com.example.healthclub_app.Models.PromoVidModel;
import com.example.healthclub_app.R;

import java.util.List;

public class PromoVidAdapter  extends RecyclerView.Adapter<PromoVidAdapter.PromoHolder> {
    Context context;
    List<PromoVidModel> vidList;

    public PromoVidAdapter(Context context, List<PromoVidModel> vidList) {
    ...
    public PromoHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.vid_list_item,parent,false);
